...
class AlbumGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<ContentModel>(builder: (context, contentModel, child) {
      return GridView.builder(
        padding: const EdgeInsets.all(24),
        itemCount: contentModel.albums.length,
        gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
            crossAxisCount: 2, mainAxisSpacing: 6, crossAxisSpacing: 12),
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
                    ...
                    children: [
                      FilledButton(
                        onPressed: () async {
                          ...
                          await PlayerModel.instance
                              .setPlaylist(album.song, index: 0);
        ...
        return InkWell(
            onTap: () async {
              await PlayerModel.instance
                  .setPlaylist(album.song, index: index - 1);
              await PlayerModel.player.play();
            },
